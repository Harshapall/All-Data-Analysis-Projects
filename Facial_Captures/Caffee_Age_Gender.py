...
while cv2.waitKey(1) < 0:
    ...
    for faceBox in faceBoxes:
        ...
        cv2.putText(resultImg, f'Gender: {gender}', (faceBox[0], faceBox[1] - 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8,
                    (0, 255, 255), 2, cv2.LINE_AA)
        cv2.putText(resultImg, f'Age: {age}', (faceBox[0], faceBox[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.8,
                    (0, 255, 255), 2, cv2.LINE_AA)
